<template>
  <aside>
    ...
    <section>
      ...
      <ul class="linkList">
        <li>
          <AppLink href="https://github.com/pavel-voronin" target="_blank" silent no-visited class="linkRow">
            <template #left>
...
.sectionDivider {
  @apply border-t border-edge/70;
}

.sectionTitle {
  @apply text-lg font-semibold text-caption;
}
